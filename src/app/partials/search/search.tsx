...
import { SearchProps, SearchRefProps } from './search.type'

const Search = forwardRef((props: SearchProps, ref: Ref<SearchRefProps>) => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-between text-gray-600 relative" style={{ height: 38 }}>
        ...
        >
          <input
            className={`${className} w-full border border-gray-300 bg-white h-full pl-4 py-2 pr-14 rounded-md text-base focus:outline-none focus:border-blue-600`}
