...
import { AdvancedSkillItemRef, AdvancedSkillValue } from 'app/partials/metadata/metadata.type'

export const AdvancedSkillItem1 = forwardRef((props: Record<string, unknown>, ref: Ref<AdvancedSkillItemRef>) => {
