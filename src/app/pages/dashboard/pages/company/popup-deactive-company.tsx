...
export const PopupDeactive: React.FC = () => {
  ...
  const [recoilState, setRecoilState] = useRecoilState(showDeactiveCompanyAdminState)
  ...
  return (
    <PopupConfirm
      ...
      type="danger"
      onHide={onHidePopup}
      onChange={onDeactiveCompany}
      okTitle="Xác nhận"
      cancelTitle="Hủy"
    >
      <div className="flex items-center justify-center">
        <span className="py-4 text-xl font-medium">Ngừng kích hoạt công ty này ?</span>
      </div>
    </PopupConfirm>
  )
}
