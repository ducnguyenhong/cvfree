...
import { Columns, TableLoader } from './candidate.data'
import { userInfoState } from 'app/states/user-info-state'
import { getDataFilter } from './candidate.filter'

export const prefix = 'candidateUserList'
...
export const CandidateList: React.FC = () => {
  ...
  useEffect(() => {
    document.title = `CVFREE | Danh sách ứng viên`
  }, [])
  ...
  const Toolbar: React.FC = () => {
    return (
      ...
      >
        ...
        <span className="text-white font-semibold hidden sm:inline">Tạo ứng viên</span>
  ...
  const Wrapper: React.FC = (props) => {
    return (
      <WrapperTable title="Danh sách ứng viên" toolbar={userInfo?.type === 'ADMIN' ? <MemoToolbar /> : undefined}>
