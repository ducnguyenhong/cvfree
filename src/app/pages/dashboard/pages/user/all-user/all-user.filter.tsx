import { dataOptionActive, dataOptionUserType, dataOptionUserVerify } from 'constants/data-filter'
...
export const getDataFilter: (prefix: string) => DataFilter[] = (prefix) => [
  ...
  {
    FilterComponent: <FilterDefault param="type" label="Loại" options={dataOptionUserType} prefix={prefix} />
  },
  {
