...
export const AllUserList: React.FC = () => {
  ...
  const Toolbar: React.FC = () => {
    return (
      ...
      >
        ...
        <span className="text-white font-semibold hidden sm:inline">Create user</span>
        <span className="text-white font-semibold sm:hidden">Create</span>
      </Link>
    )
  }
  ...
  const Wrapper: React.FC = (props) => {
    return (
      <WrapperTable title="All user" toolbar={userInfo?.type === 'ADMIN' ? <MemoToolbar /> : undefined}>
