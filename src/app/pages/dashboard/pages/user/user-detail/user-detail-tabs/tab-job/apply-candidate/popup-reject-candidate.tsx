...
export const PopupRejectCandidate: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="py-5 px-10">
        <span className="text-xl font-semibold block">Từ chối ứng viên này ?</span>
        <span className="block mt-5 font-medium">
          - Sau khi xác nhận, một email tự động sẽ được gửi tới ứng viên thông báo rằng họ chưa đủ yêu cầu của nhà tuyển
          dụng
        </span>
      </div>
    </PopupConfirm>
