...
export const PopupActive: React.FC = () => {
  ...
  const [recoilState, setRecoilState] = useRecoilState(showActiveJobAdminState)
  ...
  return (
    <PopupConfirm
      ...
      type="success"
      onHide={onHidePopup}
      onChange={onActiveJob}
      okTitle="Xác nhận"
      cancelTitle="Hủy"
    >
      <div className="flex items-center justify-center">
        <span className="py-4 text-xl font-medium">Kích hoạt việc làm này ?</span>
      </div>
    </PopupConfirm>
  )
}
