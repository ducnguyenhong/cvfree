...
export const PopupDeactive: React.FC = () => {
  ...
  const onDeactiveCv = () => {
    ...
    const url = `${SERVER_URL}/admin/cvs/change-status/${id}`
    const headers = {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        <span className="py-4 text-xl font-medium">Ngừng kích hoạt hồ sơ này ?</span>
      </div>
    </PopupConfirm>
  )
}
