...
import { DataDemoCV, DataFontFamilyCv, DataFontSizeCv, DataRecommendCv, DataRecommendCvType } from 'constants/data-cv'
...
export const CvFormLayout2: React.FC<CvFormProps> = (props) => {
  ...
  const [color, setColor] = useState<string>('#DF4082')
          ...
          >
            ...
            <div className="grid grid-cols-5 h-full">
                  ...
                  <div className={`${isShowCropAvatar ? '' : 'z-10'} absolute top-52 left-0 h-52 w-full`}>
                    <div className="pl-20">
                      <PrInputCV
                        ...
                        onBlur={() => onChangeRecommend(null)}
                        divClassName="h-8"
                        className="uppercase font-bold text-lg w-full text-center py-2"
                      />
                    </div>
                    <div className="mt-1 mb-5 pl-20">
                      <PrInputCV
                        ...
                        divClassName="h-8"
                        className="bg-transparent uppercase font-medium w-full text-center text-gray-600 py-2"
                      />
                    </div>
                  </div>
                  <div className="div-triagle-top-left absolute transform bg-white z-0"></div>
                </div>

                <div className="div-middle-left ml-4 mr-12 mt-4">
                  <div className="flex items-center justify-end">
                    <div className="flex items-center">
                      <DatePicker
                        ...
                        className="h-8 w-full py-2 pr-4 bg-transparent focus:outline-none z-20 text-right"
                      />
                  ...
                  <div className="flex items-center">
                    <PrInputCV
                      ...
                      className="bg-transparent w-full py-2 text-right"
                    />
                    <div className="opacity-70">
                      <GenderIcon />
                    </div>
              ...
              <div className="col-span-3 relative p-4 overflow-hidden">
                ...
                <div
                  className="div-triangle-bottom-left absolute -bottom-20 -right-7 w-48 h-28"
