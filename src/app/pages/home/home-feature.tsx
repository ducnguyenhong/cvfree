...
const FeatureHome: React.FC = () => {
  return (
    <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-64 mt-20 pb-20">
      <div className="text-center">
        <span className="uppercase font-bold text-4xl">CVFREE CÓ GÌ ?</span>
      </div>
      ...
      <div className="text-center mt-10">
        <Link
          to="/"
          className="rounded-md bg-green-600 text-white px-5 py-3 uppercase font-medium text-lg duration-300 hover:bg-green-700"
        >
          Tạo CV ngay
        </Link>
      </div>
